...
/* --> gpio_test */
extern xdc_Void gpio_test(xdc_UArg,xdc_UArg);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/felipe/Arquivos_RTOS/GPIO_LedBlink_bbbAM335x_armTestProject/Release/configPkg/package/cfg/am335x_app_bbbam335x_pa8fg");
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[1] = {
    {/* instance#0 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg,xdc_UArg))((xdc_Fxn)gpio_test)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)0),  /* env */
